...
class PengaturanTambakController extends Controller
{
     ...
     */
    private function cekRelasi($tabel, $id) {
    ...
    public function updateUkuran(Request $request, $id) {
        ...
        return redirect()->back()->with('success', 'Kategori ukuran benur berhasil diperbarui.')->with(['last_tab' => 'kcriteria', 'last_sub_tab' => 'ukuran']);
    }
    ...
    public function destroyUkuran($id) {
        ...
        return redirect()->back()->with('success', 'Kategori ukuran benur berhasil dihapus.')->with(['last_tab' => 'kcriteria', 'last_sub_tab' => 'ukuran']);
    }
    ...
    public function storeGrade(Request $request) {
        ...
        return redirect()->back()->with('success', 'Tingkatan grade benur baru berhasil didaftarkan.')->with(['last_tab' => 'kcriteria', 'last_sub_tab' => 'grade']);
    }
    ...
    public function updateGrade(Request $request, $id) {
        ...
        return redirect()->back()->with('success', 'Tingkatan grade benur berhasil diperbarui.')->with(['last_tab' => 'kcriteria', 'last_sub_tab' => 'grade']);
    }
    ...
    public function destroyGrade($id) {
        ...
        return redirect()->back()->with('success', 'Tingkatan grade benur berhasil dihapus.')->with(['last_tab' => 'kcriteria', 'last_sub_tab' => 'grade']);
    }
